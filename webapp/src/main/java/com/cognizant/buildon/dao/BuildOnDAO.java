...
public interface BuildOnDAO {
	 ...
	 * @return
	 */
	public boolean  saveScmDet(String userId,String switchval,String type,String url,String oauthtoken,String id) ;
	 ...
	 * @return
	 */
	public Reports getIndividualReports(String scmuser);
	 ...
	 * @return
	 */
	public Reports getIndividualstatusReports(String scmuser, String commitid);

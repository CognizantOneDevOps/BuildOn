 ...
 */
@WebServlet("/ScmUserDetailsServlet")
public class ScmUserDetailsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String res=String.valueOf(status);

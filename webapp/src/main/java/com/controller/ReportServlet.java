...
public class ReportServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		json=buildonservice.getIndividualReports(userinfo.getEmail());
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//boolean isValidUser=service.isValidEmail(scmuser);
		...
		if(null!=userId && !(userId.equals(""))){
		Users userinfo=buildonservice.getEmailForUser(userId);
		json=buildonservice.getIndividualstatusReports(userinfo.getEmail(),commitid);
		response.getWriter().write(json.toString());
		}else{
			deleteCookies(response, cookie);
			responseStr=Constants.INVALID;

 ...
 *
 */
@WebServlet("/HistoricCIServlet")
public class HistoricCIServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<String> listbranch=GitOperations.gethistoricalBranch(userId,repo);
		String json = new Gson().toJson(listbranch);

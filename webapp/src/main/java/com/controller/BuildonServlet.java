 ...
 */
@WebServlet("/BuildonServlet")
public class BuildonServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static  final Logger logger=LoggerFactory.getLogger(BuildonServlet.class);

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public BuildonServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String encryptKey=service.getEncryptkey();
		response.getWriter().write(encryptKey);

...
import com.domain.GitOperations;
 ...
 */
@WebServlet("/ScmPersistServlet")
public class ScmPersistServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ScmPersistServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String res=String.valueOf(isvalid);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(isValidurl && isValidAuth && isValidUser){
			isSaved=buildonservice.saveScmDet(userId,switchval,type,url,oauthtoken,id);
		}
		String res=String.valueOf(isSaved);
		response.getWriter().write(res);
	}

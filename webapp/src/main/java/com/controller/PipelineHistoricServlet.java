 ...
 *
 */
@WebServlet("/PipelineHistoricServlet")
public class PipelineHistoricServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static  final Logger logger=LoggerFactory.getLogger(PipelineHistoricServlet.class);


	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public PipelineHistoricServlet() {
		super();
	}
